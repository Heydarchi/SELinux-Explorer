...
class TestSeAppAnalyzer(unittest.TestCase):
    def test_extract_definition(self):
        ...
        se_app_analyzer.policy_file = PolicyFile("test.te", "", FileTypeEnum.SEAPP_CONTEXTS)
        ...
        self.assertEqual(se_app.is_system_server, False)
        self.assertEqual(se_app.is_ephemeral_app, True)
        self.assertEqual(se_app.from_run_as, "app7")
        self.assertEqual(se_app.min_target_sdk_version, "21")
